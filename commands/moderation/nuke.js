...
React with :x: to deny}{color:$getVar[embedc]}{footer:If you confirm, $channelname[$findchannel[$message;yes]] will be deleted and recreated with all same permissions};yes]; ]
...
$onlyperms[managechannels;Permissions required for execution of the command#COLON# \`Manage Channels\`. You do not have the necessary permissions!]`})
